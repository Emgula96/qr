...
(function (n, t, i) {
  ...
  var r,
    h,
    s = t.document.readyState === 'complete',
    e = n(t),
    ...
    y = function (n) {
      var i, u;
      n._.configuredStopReconnectingTimeout ||
        ((u = function (n) {
          n.log(
            "Couldn't reconnect within the configured timeout (" +
              n.disconnectTimeout +
              'ms), disconnecting.'
          );
          n.stop(!1, !1);
  ...
  r.fn = r.prototype = {
    ...
    isCrossDomain: function (i, r) {
      ...
      return ((i = n.trim(i)), (r = r || t.location), i.indexOf('http') !== 0)
        ...
        : ((u = t.document.createElement('a')),
          (u.href = i),
          u.protocol + l(u.protocol, u.host) !==
            r.protocol + l(r.protocol, r.host));
    },
    ajaxDataType: 'text',
    ...
    start: function (i, h) {
      var l = this,
        ...
        k,
        v = l._deferral || n.Deferred(),
        w = t.document.createElement('a'),
        b,
        d;
      if (((l._deferral = v), !l.json))
        throw new Error(
      ...
      if (
        (n.type(i) === 'function'
          ...
          : n.type(i) === 'object' &&
            (n.extend(a, i),
            n.type(a.callback) === 'function' && (h = a.callback)),
        (a.transport = p(a.transport, l)),
        !a.transport)
      )
        throw new Error(
          'SignalR: Invalid transport(s) specified, aborting start.'
        );
      return ((l._.config = a), !s && a.waitForPageLoad === !0)
        ? ((l._.deferredStartHandler = function () {
            l.start(i, h);
          }),
          e.bind('load', l._.deferredStartHandler),
          v.promise())
        : l.state === r.connectionState.connecting
          ? v.promise()
          : o(
                l,
            ...
            ? (v.resolve(l), v.promise())
            : (y(l),
              (w.href = l.url),
              w.protocol && w.protocol !== ':'
                ? ((l.protocol = w.protocol),
                  (l.host = w.host),
                  (l.baseUrl = w.protocol + '//' + w.host))
                : ((l.protocol = t.document.location.protocol),
                  (l.host = t.document.location.host),
                  (l.baseUrl = l.protocol + '//' + l.host)),
              (l.wsProtocol = l.protocol === 'https:' ? 'wss://' : 'ws://'),
              a.transport === 'auto' &&
                a.jsonp === !0 &&
                (a.transport = 'longPolling'),
              l.url.indexOf('//') === 0 &&
                ((l.url = t.location.protocol + l.url),
                l.log(
                  "Protocol relative URL detected, normalizing it to '" +
                    l.url +
                    "'."
                )),
              this.isCrossDomain(l.url) &&
                (l.log('Auto detected cross domain url.'),
                a.transport === 'auto' &&
                  (a.transport = [
                    'webSockets',
                    'serverSentEvents',
                ...
                typeof a.withCredentials == 'undefined' &&
                  (a.withCredentials = !0),
                a.jsonp ||
                  ((a.jsonp = !n.support.cors),
                  a.jsonp &&
                    l.log(
                      "Using jsonp because this browser doesn't support CORS."
                    )),
                (l.contentType = r._.defaultContentType)),
              (l.withCredentials = a.withCredentials),
              (l.ajaxDataType = a.jsonp ? 'jsonp' : 'text'),
              n(l).bind(u.onStart, function () {
                  ...
                  try {
                    ...
                    h.start(
                      ...
                      function () {
                        ...
                        l.state !== r.connectionState.disconnected &&
                          (c ||
                            ((c = !0),
                            t.clearTimeout(l._.onFailedTimeoutHandle),
                            h.supportsKeepAlive &&
                              l._.keepAliveData.activated &&
                              r.transports._logic.monitorKeepAlive(l),
              ...
              n(l).triggerHandler(u.onStarting),
              (b = r.transports._logic.prepareQueryString(l, b)),
              (b = r.transports._logic.addQs(b, {
                clientProtocol: l.clientProtocol,
              })),
              l.log("Negotiating with '" + b + "'."),
              (l._.negotiateRequest = n.ajax(
                n.extend({}, n.signalR.ajaxDefaults, {
                  ...
                  success: function (t) {
                    ...
                    if (
                      ((e = l._.keepAliveData),
                      (l.appRelativeUrl = i.Url),
                      (l.id = i.ConnectionId),
                      (l.token = i.ConnectionToken),
                      (l.webSocketServerUrl = i.WebSocketServerUrl),
                      (l.disconnectTimeout = i.DisconnectTimeout * 1e3),
                      (l._.totalTransportConnectTimeout =
                      ...
                      i.KeepAliveTimeout
                        ? ((e.activated = !0),
                          ...
                          (e.timeoutWarning = e.timeout * l.keepAliveWarnAt),
                          (l._.beatInterval =
                            (e.timeout - e.timeoutWarning) / 3))
                        : (e.activated = !1),
                      (l.reconnectWindow =
                        l.disconnectTimeout + (e.timeout || 0)),
                      !i.ProtocolVersion ||
                        i.ProtocolVersion !== l.clientProtocol)
                    ) {
                      h = r._.error(
                        r._.format(
                    ...
                    n.isArray(a.transport)
                      ? n.each(a.transport, function (t, i) {
                          n.inArray(i, s) >= 0 && o.push(i);
                        })
                      : a.transport === 'auto'
                        ? (o = s)
                        : n.inArray(a.transport, s) >= 0 && o.push(a.transport);
                    k(o);
                  },
                })
              )),
    ...
    stop: function (i, h) {
      var l = this,
        a = l._deferral;
      if (
        (l._.deferredStartHandler && e.unbind('load', l._.deferredStartHandler),
        delete l._deferral,
        delete l._.config,
        delete l._.deferredStartHandler,
        !s && (!l._.config || l._.config.waitForPageLoad === !0))
      ) {
      ...
      if (l.state !== r.connectionState.disconnected)
        return (
          ...
          l.transport &&
            (l.transport.stop(l),
            h !== !1 && l.transport.abort(l, i),
            l.transport.supportsKeepAlive &&
              l._.keepAliveData.activated &&
              r.transports._logic.stopMonitoringKeepAlive(l),
            (l.transport = null)),
          l._.negotiateRequest &&
            (l._.negotiateRequest.abort(c), delete l._.negotiateRequest),
  ...
  (function (n, t) {
    ...
    function o(t) {
      var r = t._.keepAliveData,
        f;
      t.state === i.connectionState.connected &&
        ((f = new Date().getTime() - t._.lastMessageAt),
        f >= r.timeout
          ? (t.log(
          ...
          : f >= r.timeoutWarning
            ? r.userNotified ||
              ...
              n(t).triggerHandler(u.onConnectionSlow),
              (r.userNotified = !0))
            : (r.userNotified = !1));
    }
    function s(n, i) {
    ...
    r = i.transports._logic = {
      pingServer: function (t) {
        ...
        return (
          t.transport
                ...
                n.extend({}, n.signalR.ajaxDefaults, {
                  ...
                  success: function (n) {
                    ...
                    try {
                      ...
                      u.reject(
                        i._.transportError(
                          i.resources.pingServerFailedParse,
                          t.transport,
                          e,
                          f
                        )
                    ...
                    r.Response === 'pong'
                      ...
                      : u.reject(
                          i._.transportError(
                            i._.format(
                              i.resources.pingServerFailedInvalidResponse,
                              n.responseText
                            ),
                            t.transport,
                            null,
                  ...
                  error: function (n) {
                    n.status === 401 || n.status === 403
                      ? (u.reject(
                          i._.transportError(
                            i._.format(
                              i.resources.pingServerFailedStatusCode,
                              n.status
                            ),
                            t.transport,
                            n,
            ...
            : u.reject(
                i._.transportError(
                  i.resources.noConnectionTransport,
                  t.transport
                )
              ),
          u.promise()
      ...
      prepareQueryString: function (n, t) {
        return (t = r.addQs(t, n.qs)), s(t, n.data);
      },
      addQs: function (t, i) {
        var r = t.indexOf('?') !== -1 ? '&' : '?',
          u;
      ...
      getUrl: function (n, i, u, f) {
        var s = i === 'webSockets' ? '' : n.baseUrl,
          ...
          o =
            ...
            i +
            '&connectionToken=' +
            t.encodeURIComponent(n.token);
        return (
          n.groupsToken &&
            (o += '&groupsToken=' + t.encodeURIComponent(n.groupsToken)),
          u
            ? ((e += f ? '/poll' : '/reconnect'),
              n.messageId &&
                (o += '&messageId=' + t.encodeURIComponent(n.messageId)))
            : (e += '/connect'),
          (e += '?' + o),
      ...
      ajaxSend: function (f, e) {
        var c = r.stringifySend(f, e),
          o =
            ...
            f.transport.name +
            '&connectionToken=' +
            t.encodeURIComponent(f.token),
          s,
          h = function (t, r) {
            n(r).triggerHandler(u.onError, [
              i._.transportError(i.resources.sendFailed, r.transport, t, s),
              e,
            ]);
          };
        return (
          (o = r.prepareQueryString(f, o)),
          (s = n.ajax(
            n.extend({}, n.signalR.ajaxDefaults, {
      ...
      triggerReceived: function (t, i) {
        t._.connectingMessageBuffer.tryBuffer(i) ||
          n(t).triggerHandler(u.onReceived, [i]);
      },
      ...
      markActive: function (n) {
        return r.verifyLastActive(n)
          ? ((n._.lastActiveAt = new Date().getTime()), !0)
          : !1;
      },
      isConnectedOrReconnecting: function (n) {
        return (
          n.state === i.connectionState.connected ||
          n.state === i.connectionState.reconnecting
        );
      },
      ensureReconnectingState: function (t) {
        return (
          e(t, i.connectionState.connected, i.connectionState.reconnecting) ===
            !0 && n(t).triggerHandler(u.onReconnecting),
      ...
      verifyLastActive: function (n) {
        return new Date().getTime() - n._.lastActiveAt >= n.reconnectWindow
          ? (n.log(
      ...
      reconnect: function (n, u) {
        ...
        if (r.isConnectedOrReconnecting(n) && !n._.reconnectTimeout) {
          ...
          n._.reconnectTimeout = t.setTimeout(function () {
            r.verifyLastActive(n) &&
              (f.stop(n),
              r.ensureReconnectingState(n) &&
                (n.log(u + ' reconnecting.'), f.start(n)));
          }, n.reconnectDelay);
        }
      },
      handleParseFailure: function (t, r, f, e, o) {
        t.state === i.connectionState.connecting
          ? (t.log(
          ...
          : (n(t).triggerHandler(u.onError, [
              i._.transportError(
                i._.format(i.resources.parseFailed, r),
                t.transport,
                f,
                o
              ),
              ...
              if (c)
                typeof t.wasClean != 'undefined' && t.wasClean === !1
                  ? (n(e).triggerHandler(u.onError, [
                    ...
                    e.log(
                      'Unclean disconnect from websocket: ' + t.reason ||
                        '[no reason given].'
                    ))
  ...
  (function (n, t) {
    ...
    i.transports.serverSentEvents = {
      ...
      start: function (e, o, s) {
        ...
        if (
          (e.eventSource &&
            (e.log('The connection already has an event source. Stopping it.'),
            e.stop()),
          !t.EventSource)
        ) {
        ...
        a &&
          (y = t.setTimeout(function () {
            c === !1 &&
              e.eventSource.readyState !== t.EventSource.OPEN &&
              h.reconnect(e);
          }, h.timeOut));
        e.eventSource.addEventListener(
          'open',
          function () {
            ...
            c === !1 &&
              ...
              ) === !0 && l.triggerHandler(u.onReconnect));
          },
          !1
        );
        e.eventSource.addEventListener(
        ...
        e.eventSource.addEventListener(
          ...
          function (n) {
            if (this === e.eventSource) {
              ...
              e.log(
                'EventSource readyState: ' + e.eventSource.readyState + '.'
              );
  ...
  (function (n, t) {
    ...
    r.transports.foreverFrame = {
      ...
      start: function (n, r, e) {
        ...
        if (t.EventSource) {
          e &&
            (n.log('This browser supports SSE, skipping Forever Frame.'), e());
          return;
        }
    ...
    i.transports.longPolling = {
      ...
      start: function (o, s, h) {
        var a = this,
          ...
          y = function () {
            return h
              ? (h(), (h = null), o.log('LongPolling failed to connect.'), !0)
              : !1;
          },
          c = o._,
          l = 0,
          p = function (r) {
            ...
            e(
              ...
              (r.log('Raising the reconnect event'),
              n(r).triggerHandler(u.onReconnect));
          },
          w = 36e5;
        o.pollXhr &&
        ...
        c.pollTimeoutId = t.setTimeout(function () {
          (function e(s, h) {
            ...
            f(s) !== !0 &&
              (o.log("Opening long polling request to '" + k + "'."),
              (s.pollXhr = n.ajax(
                n.extend({}, n.signalR.ajaxDefaults, {
                  ...
                  success: function (i) {
                    ...
                    h && (u = r.maximizePersistentResponse(h)),
                    r.processMessages(s, h, v),
                    u &&
                  ...
                  error: function (f, h) {
                    ...
                    if (!y()) {
                      if (
                        (l++,
                        o.state !== i.connectionState.reconnecting &&
                          (o.log(
                          ...
                          n(s).triggerHandler(u.onError, [
                            i._.transportError(
                              i.resources.longPollFailed,
                              o.transport,
                              f,
                              s.pollXhr
                            ),
                          ])),
                        (o.state === i.connectionState.connected ||
                          o.state === i.connectionState.reconnecting) &&
                          !r.verifyLastActive(o))
                      )
                        return;
              ...
              b &&
                h === !0 &&
                (c.reconnectTimeoutId = t.setTimeout(
                  function () {
                    p(s);
                  },
      ...
      u.received(function (t) {
        ...
        t &&
          (typeof t.I != 'undefined'
            ? ((f = t.I.toString()),
              (e = u._.invocationCallbacks[f]),
              e &&
                ((u._.invocationCallbacks[f] = null),
                delete u._.invocationCallbacks[f],
                e.method.call(e.scope, t)))
            : ((i = this._maximizeClientHubInvocation(t)),
              u.log(
              ...
              (s = i.Hub.toLowerCase()),
              (h = i.Method.toLowerCase()),
              (o = this.proxies[s]),
              n.extend(o.state, i.State),
              n(o).triggerHandler(r(h), [i.Args])));
      });
