      ...
      <Content>
        <div className='qr-inner-content-wrapper'>
          <form>
            ...
            <FormField label='E-mail Address' htmlFor='email-field' placeholder='Enter E-mail' type='email' note="We'll never share your email with anyone else." value={email} onChange={onChangeInput} onFocus={onFocusInput} />
            <FormField label='First Name' htmlFor='fname-field' placeholder='Enter First Name' type='text' value={firstName} onChange={onChangeInput} onFocus={onFocusInput} />
            <FormField label='Last Name' htmlFor='lname-field' placeholder='Enter Last Name' type='text' value={lastName} onChange={onChangeInput} onFocus={onFocusInput} />
