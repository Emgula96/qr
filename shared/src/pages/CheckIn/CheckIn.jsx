            ...
            <div className="badge-wrapper">
                ...
                <div className="messages">
                    ...
                    <div className="details">
                        ...
                        {!success && (
                            <p>
                                Please contact the facilitator for more
                                information
                            </p>
                        )}
                    </div>
                    ...
                    <div className="check-in-wrapper">
                        <div className="left">
                            <div className="scanner">
                                <div className="scanner-content">
                                    ...
                                    <p>
                                        <em>
                                            Scan QR Code by holding printed
                                            badge under camera located at the
                                            bottom of this device.
                                        </em>
                                    </p>
                                    <QRCodeScanner
                                        fps={10}
                        ...
                        <div className="center">
                            ...
                            <Status
                                status={status}
                                attendeeName={
                                    attendence[0]?.name || 'Test Attendee'
                                }
                            />
