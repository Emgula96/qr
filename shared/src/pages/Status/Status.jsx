    ...
    switch (status) {
      ...
      case 'Session event or user not found':
        return {
          ...
          message:
            'The session event or user you are trying to check in for does not exist.',
      ...
      case 'Insufficient credit to complete check-in':
        return {
          ...
          message:
            'You do not have enough credit to check in for this session.',
  ...
  return (
    <div className="status-wrapper">
      ...
      <div className={`status-container ${statusContent?.className}`}>
        <div
          className={
            status === 'Success' ? 'status-icon-success' : 'status-icon'
          }
        ></div>
