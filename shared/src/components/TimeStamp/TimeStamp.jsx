...
function TimeStamp(props) {
  ...
  return (
    <div
      className={
        isVertical
          ? 'timestamp-wrapper-vertical'
          : 'timestamp-wrapper-horizontal'
      }
    >
      <div
        className={
          isVertical ? 'timestamp-date-vertical' : 'timestamp-date-horizontal'
        }
      >
        {dateString}
      </div>
      <div
        className={
          isVertical ? 'timestamp-time-vertical' : 'timestamp-time-horizontal'
        }
      >
        {timeString}
      </div>
